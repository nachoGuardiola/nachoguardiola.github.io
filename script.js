...
const translations = {
  ...
  en: {
    ...
    "nav-contact": "Contact",
    "hero-eyebrow": "Web developer • Front end and back end",
    "hero-title": "I build clear, useful web solutions focused on results.",
    "hero-lead": "I develop modern applications and websites that turn visitors into customers and streamline business processes.",
    "hero-projects": "View projects",
    "hero-contact": "Let's talk",
    "availability": "Available for web opportunities and projects.",
    ...
    "skills-eyebrow": "Core technical stack",
...
const revealElements = [
  ...document.querySelectorAll(
    ".hero-text, .hero-card, .section-heading, .about-grid > *, .experience-item, .education-card, .skills-list, .project-card, .contact-section > p, .contact-section > .btn",
  ),
];
